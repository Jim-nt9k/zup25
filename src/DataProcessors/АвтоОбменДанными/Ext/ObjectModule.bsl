...
Процедура ИнициироватьОбменДанными(МассивСсылокНастроек, ОбменПриПервомВходеВПрограмму = Ложь)
	...
	#Если Клиент Тогда
		СоответсвиеТекстов = глЗначениеПеременной("глСоответствиеТекстовЭлектронныхПисем");
	#Иначе
...
#Если Клиент тогда
	мКоличествоСекундОпросаОбмена = глЗначениеПеременной("глКоличествоСекундОпросаОбмена");
#Иначе
	мКоличествоСекундОпросаОбмена = 60;	
#КонецЕсли

мКоэффициентУменьшенияИнтервалов = ПроцедурыОбменаДанными.ВернутьКоэффициентУменьшенияИнтерваловВызоваОбработчиковОбмена();