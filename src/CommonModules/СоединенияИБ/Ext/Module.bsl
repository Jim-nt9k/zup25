...
//
Функция ПараметрыБлокировкиСеансов(Знач ПолучитьКоличествоСеансов = Ложь) Экспорт //О.Т. Аверсон 23.10.2015 № 658
...
//
Функция ОтключитьСеанс(НомерСеанса, Сообщение) Экспорт  //О.Т. Аверсон 23.10.2015 № 658
...
//+ СВЭЙ КДЯ 17.10.19 СВФР-004932
Функция ЭтоSQL() Экспорт
	Возврат Найти( СтрокаСоединенияИнформационнойБазы(), "Srvr=" ) > 0;
КонецФункции // ЭтоSQL()
//- СВЭЙ КДЯ 17.10.19 СВФР-004932
...
//
Функция КоличествоСеансовИнформационнойБазы(УчитыватьКонсоль = Истина, //О.Т. Аверсон 23.10.2015 № 658
	СообщенияДляЖурналаРегистрации = Неопределено) Экспорт  //О.Т. Аверсон 23.10.2015 № 658
...
//
Процедура ЗаписатьНазванияСоединенийИБ(Знач ТекстСообщения) Экспорт //О.Т. Аверсон 23.10.2015 № 658
