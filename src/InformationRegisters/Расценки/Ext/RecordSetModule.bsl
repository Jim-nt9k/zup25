...
Процедура РассчитатьПоСтавкеПервогоРазряда(ДатаРасчета, Организация) Экспорт
	...
	//Аверсон 04.03.2019 КВВ СВФР-003212 (
	|	РасценкиСрезПоследних.Расценка3, 
	|	РасценкиСрезПоследних.Расценка4, 
	|	РасценкиСрезПоследних.Расценка5, 
	|	РасценкиСрезПоследних.Расценка6, 
	//Аверсон 04.03.2019 КВВ СВФР-003212 )
	|	РасценкиСрезПоследних.Валюта,
	|	РасценкиСрезПоследних.Комментарий,
	|	РасценкиСрезПоследних.Расценка2
	|ИЗ
