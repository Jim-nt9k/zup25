...
Процедура ЗаполнитьПоПерерассчитываемомуДокументу(ИсходныйДокумент, Знач Сотрудники = Неопределено) Экспорт
	...
	Если Сотрудники = "ПоДаннымПерерасчета" Тогда
		...
		|ИЗ
		|	Документ.РаспределениеПремииПоКТУРаботниковОрганизаций.Начисления КАК СотрудникиОрганизаций
		|ГДЕ
		...
		|					Начисления.Сотрудник
		|				ИЗ
		|					Документ.РаспределениеПремииПоКТУРаботниковОрганизаций.Начисления КАК Начисления
		|				ГДЕ
...
Функция СформироватьЗапросДляПечати(Режим)
	...
	Если Режим = "ПоРеквизитамДокумента" Тогда
		...
		|ИЗ
		|	Документ.РаспределениеПремииПоКТУРаботниковОрганизаций КАК ПремииРаботниковОрганизации
	...
	ИначеЕсли Режим = "ПоТабличнойЧастиДокумента" Тогда
		...
		|ИЗ
		|	Документ.РаспределениеПремииПоКТУРаботниковОрганизаций.Начисления КАК ПремииРаботниковОрганизацииНачисления
		|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РаботникиОрганизаций.СрезПоследних(
		|				&ДатаДокумента,
		|				Сотрудник В
		|					(ВЫБРАТЬ РАЗЛИЧНЫЕ
...
Функция СформироватьЗапросПоНачисления(ВыборкаПоШапкеДокумента, Сотрудник = Неопределено)
	...
	|	СтрокиНачисления.Тариф КАК Показатель1,
	|	СтрокиНачисления.КТУ КАК Показатель2,
	|	ВЫБОР
	...
	|ИЗ
	|	Документ.РаспределениеПремииПоКТУРаботниковОрганизаций.Начисления КАК СтрокиНачисления
	|		ЛЕВОЕ СОЕДИНЕНИЕ РегистрСведений.РаботникиОрганизаций.СрезПоследних(
	|		&ДатаРегистрации,
	|		Сотрудник В
	|			(ВЫБРАТЬ РАЗЛИЧНЫЕ
