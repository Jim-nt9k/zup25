...
Процедура ДобавитьСтрокуВДвиженияПоРегистрамНакоплений(ВыборкаПоШапкеДокумента, ВыборкаПоСтрокамДокумента, 
	...
	Если СтруктураПроведенияПоРегистрамНакоплений.Свойство(ИмяРегистра) Тогда
		...
		// Ресурсы
		Движение.СуммаЗатрат	= ОбщегоНазначения.ПересчитатьИзВалютыВВалюту(ВыборкаПоСтрокамДокумента.Сумма,ВыборкаПоСтрокамДокумента.Валюта,мВалютаУправленческогоУчета,
																		ВыборкаПоСтрокамДокумента.КурсДокумента ,ВыборкаПоСтрокамДокумента.Курс,
																		ВыборкаПоСтрокамДокумента.КратностьДокумента,ВыборкаПоСтрокамДокумента.Кратность,ВыборкаПоСтрокамДокумента.Дата);//О.Т. Аверсон 12.03.2016 № 949
