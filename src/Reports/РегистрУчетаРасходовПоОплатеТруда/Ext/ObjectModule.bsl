...
Функция ПолучитьРезультатЗапроса()
	...
	Запрос.УстановитьПараметр("Счет44_01",  ПланыСчетов.Налоговый.КомерческиеРасходы);
	
	СчетКосвенныхРасходов = Новый Массив;                          
	СчетКосвенныхРасходов.Добавить(ПланыСчетов.Налоговый.РасходыНаРеализацию);							 // Счет44
	...
	СчетКосвенныхРасходов.Добавить(ПланыСчетов.Налоговый.ОбщехозяйственныеРасходыНеУчитываемые);		 // Счет26_02
	...
	СчетРасходов.Добавить(ПланыСчетов.Налоговый.РасходыНаРеализацию);			// Счет44
