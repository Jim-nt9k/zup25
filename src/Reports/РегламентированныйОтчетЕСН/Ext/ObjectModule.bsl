...
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Министерства финансов РФ от 10.02.2005 г. №21н";
НоваяФорма.ДатаНачалоДействия = '20040101';
НоваяФорма.ДатаКонецДействия  = '20041231';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2005Кв1";
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Минфина РФ от 10.02.2005 г. №21н, в редакции письма от 11.01.2006 № 03-05-02-03/1";
НоваяФорма.ДатаНачалоДействия = '20050101';
НоваяФорма.ДатаКонецДействия  = '20051231';

НоваяФорма = мТаблицаФормОтчета.Добавить();
НоваяФорма.ФормаОтчета        = "ФормаОтчета2006Кв1";
НоваяФорма.ОписаниеОтчета     = "Форма утверждена приказом Минфина РФ от 31.01.2006 г. №19н";
НоваяФорма.ДатаНачалоДействия = '20050101';
