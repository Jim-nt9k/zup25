...
Функция СформироватьЗапрос()
	...
	Если ОтборОрганизации Тогда
		...
		ТекстЗапроса = ТекстЗапроса + Символы.ПС + " И " + Символы.ПС + 
						СтрЗаменить(ТекстУсловия,"<имя поля организация>","ЕСНИсчисленный.ОбособленноеПодразделение")  // №14604 27,12,11 Дыма
...
Процедура СформироватьОтчет(ДокументРезультат, ПоказыватьЗаголовок = Ложь, ВысотаЗаголовка = 0, ТолькоЗаголовок = Ложь) Экспорт
	...
	Пока ВыборкаПоОрганизациям.Следующий() Цикл
		...
		//О.Т. Аверсон 02.06.2016 № 1193
		Если Период >= Дата(2016,07,1) Тогда 
			ОбластьСтрока.Область("R1C13").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C14").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C15").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C16").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C17").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C18").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C19").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C20").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C21").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C22").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C23").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C24").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьСтрока.Область("R1C25").Формат =  "ЧЦ=15; ЧДЦ=2";
			
			ОбластьПодвалСтр.Область("R1C13").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C14").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C15").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C16").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C17").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C18").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C19").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C20").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C21").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C22").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C23").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C24").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалСтр.Область("R1C25").Формат =  "ЧЦ=15; ЧДЦ=2";
			
			ОбластьПодвалВед.Область("R1C13").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C14").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C15").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C16").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C17").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C18").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C19").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C20").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C21").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C22").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C23").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C24").Формат =  "ЧЦ=15; ЧДЦ=2";
			ОбластьПодвалВед.Область("R1C25").Формат =  "ЧЦ=15; ЧДЦ=2";
		КонецЕсли;
		//О.Т. Аверсон 02.06.2016 № 1193
		Пока ВыборкаПоФЛ.Следующий() Цикл
			...
			Пока Выборка.Следующий() Цикл
				...
				// тарифная ставка
				ЗначениеОкругления = РегистрыСведений.РазмерыПараметровДляРасчетаРБ.ПолучитьПоследнее(Период,Новый Структура("ВидПараметра",Перечисления.ВидыПараметровДляРасчетаЗарплаты.ТочностьРасчетов)).Размер; //О.Т. Аверсон 22.06.2016 № 949
				ОписаниеТарифнаяСтавка = Формат(Выборка.ТарифнаяСтавка,"ЧЦ=15; ЧДЦ="+Строка(ЗначениеОкругления)+"; ЧН=' '; ЧГ=0");
