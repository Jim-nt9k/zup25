...
Процедура ДоработатьКомпоновщикПередВыводом() Экспорт
	...
	//Аверсон ЕАЕ 21.10.2021 СВФР-008272
	ЗначениеПараметраНеВключатьУчеников = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("НеВключатьУчеников"));
	Если ЗначениеПараметраНеВключатьУчеников <> Неопределено Тогда
		Орг = УправлениеПользователями.ПолучитьЗначениеПоУмолчанию(глЗначениеПеременной("глТекущийПользователь"), "ОсновнаяОрганизация");
		Если Орг.ИНН = "700067572" Тогда
			ЗначениеПараметраНеВключатьУчеников.Значение = НеВключатьУчеников;
		Иначе
			ЗначениеПараметраНеВключатьУчеников.Значение = Ложь;
		КонецЕсли;
		ЗначениеПараметраНеВключатьУчеников.Использование = Истина;
	КонецЕсли;
	
	ЗначениеПараметраКатегорияУченик = КомпоновщикНастроек.Настройки.ПараметрыДанных.НайтиЗначениеПараметра(Новый ПараметрКомпоновкиДанных("КатегорияУченик"));
	Если ЗначениеПараметраКатегорияУченик <> Неопределено Тогда
		ЗначениеПараметраКатегорияУченик.Значение = Справочники.КатегорииРаботников.НайтиПоНаименованию("Ученик");
		ЗначениеПараметраКатегорияУченик.Использование = Истина;
	КонецЕсли;
	//Аверсон СВФР-008272
